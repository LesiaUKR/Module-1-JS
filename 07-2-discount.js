 ...
 * 
 * [ квадратная скобка означает включительно, ) круглая до, но не включительно
* например [1, 5) - от 1го до 4 включительно, но без 5ки 
*/

// let totalSpent = 2000;
// let payment = 500;
// let discount = 0;
// // totalSpent >= 100 && totalSpent < 1000 - означает от и до
